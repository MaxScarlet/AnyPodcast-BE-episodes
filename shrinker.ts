...
let ignore: string[] = ["aws-sdk", "deepmerge", 'fs-extra', 'dotenv'];
let asIs: string[] = ["call-bind", 'mongoose', 'mongodb-connection-string-url']; // , '@tootallnate/once', 'i18n', 'messageformat', 'agent-base', 'tsutils', "superagent", 'argparse'
